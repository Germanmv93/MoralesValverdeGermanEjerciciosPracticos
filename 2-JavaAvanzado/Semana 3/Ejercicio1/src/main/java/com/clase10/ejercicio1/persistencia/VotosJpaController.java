...
import com.clase10.ejercicio1.persistencia.exceptions.NonexistentEntityException;
...
public class VotosJpaController implements Serializable {
    ...
    public VotosJpaController(){
        emf= Persistence.createEntityManagerFactory("PuVotos");
    }
    ...
    public Votos findVotos(Integer id) {
        EntityManager em = getEntityManager();
        try {
